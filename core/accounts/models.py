...
from .exceptions import EmailNotProvidedError, InvalidSuperuserError
...
class MyUserManager(BaseUserManager):
    ...
    def create_superuser(self, email, password, **extra_fields):
        ...
        if extra_fields.get('is_staff') is not True:
            raise InvalidSuperuserError('Superuser must have is_staff=True.')
        if extra_fields.get('is_superuser') is not True:
            raise InvalidSuperuserError('Superuser must have is_superuser=True.')
